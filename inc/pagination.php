...
if ( ! function_exists( 'm_taylor_pagination' ) ) {
	/**
	 ...
	 */
	function m_taylor_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'm_taylor' ),
				'next_text'          => __( '&raquo;', 'm_taylor' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'm_taylor' ),
			)
		);
