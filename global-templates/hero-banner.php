      ...
      <div class="col-12 col-md-7 mt-auto">
        ...
        <ul class="mt-4">
            <li>
                ...
                </svg> Bespoke Design & Development
            </li>
            <li>
                <svg width="26" height="26" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                ...
                </svg> Maintenance & Repairs
            </li>
            <li>
                <svg width="26" height="26" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.272 10.445 18 2l-3.728 8.445Zm-4.956.187L5 2l4.316 8.632Zm3.445-.584L8.835 2l3.926 8.048ZM14.36 2l-1.04 2.5L14.36 2ZM6 16a6 6 0 1 0 12 0 6 6 0 0 0-12 0Z"></path>
                <path d="m10.5 15 2-1.5v5"></path>
                </svg> Agency Support & White Label Services
            </li> 
        </ul>
...
<div class="container-wide partner-logos">
