	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'm_taylor' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'm_taylor' ); ?></th>
			</tr>
		</thead>
		<tbody>
